...
> 依据 `Hope and Sparks API.openapi.json` 自动生成，最后更新：2026-06-11
...
| 状态 | 方法 | 接口路径 | 说明 | 前端模块 |
|------|------|----------|------|----------|
| ✅ 已实现 | GET | `/api/v1/agents` | 获取智能体列表 | `src/api/agent.js` |
| ✅ 已实现 | POST | `/api/v1/agent-sessions` | 创建对话会话 | `src/api/agent.js` |
| ✅ 已实现 | GET | `/api/v1/agent-sessions/{sessionId}/messages` | 获取会话历史 | `src/api/agent.js` |
| ✅ 已实现 | POST | `/api/v1/agent-sessions/{sessionId}/messages` | 发送消息给智能体 | `src/api/agent.js` |
| ✅ 已实现 | GET | `/api/v1/agent-sessions/{sessionId}/stream` | Agent 流式响应 | `src/api/agent.js` |
| ✅ 已实现 | POST | `/api/v1/ai-disputes` | 举报 AI 内容争议 | `src/api/agent.js` |
...
| 状态 | 方法 | 接口路径 | 说明 | 前端模块 |
|------|------|----------|------|----------|
| ✅ 已实现 | POST | `/api/v1/uploads/token` | 获取上传凭证 | `src/api/upload.js` |
| ✅ 已实现 | POST | `/api/v1/uploads/complete` | 提交上传完成 | `src/api/upload.js` |
...
| ✅ 已实现 | GET | `/api/v1/manage/knowledge-base/documents` | 知识库文档列表 | `src/api/manage.js` |
| ✅ 已实现 | POST | `/api/v1/manage/knowledge-base/documents` | 上传知识库文档 | `src/api/manage.js` |
| ✅ 已实现 | PUT | `/api/v1/manage/knowledge-base/documents/{documentId}` | 更新知识库文档 | `src/api/manage.js` |
| ✅ 已实现 | DELETE | `/api/v1/manage/knowledge-base/documents/{documentId}` | 删除知识库文档 | `src/api/manage.js` |
| ✅ 已实现 | GET | `/api/v1/manage/knowledge-base/documents/{documentId}/parse-status` | 文档解析入库状态 | `src/api/manage.js` |
...
- OpenAPI 规范：`Hope and Sparks API.openapi.json`
