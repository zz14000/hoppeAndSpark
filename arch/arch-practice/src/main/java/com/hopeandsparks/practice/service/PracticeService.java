...
public interface PracticeService {
    ...
    AnswerSaveVO saveAnswer(AuthenticatedPrincipal principal, String exerciseSetId, String questionId, PracticeAnswerRequest request);

    FlagVO flagQuestion(AuthenticatedPrincipal principal, String exerciseSetId, String questionId, QuestionFlagRequest request);

    CoachHintVO hint(AuthenticatedPrincipal principal, String exerciseSetId, String questionId, CoachHintRequest request);

    PracticeSubmitVO submit(AuthenticatedPrincipal principal, String exerciseSetId, PracticeSubmitRequest request);

    CodeRunVO codeRun(AuthenticatedPrincipal principal, String exerciseSetId, String questionId, CodeRunRequest request);
